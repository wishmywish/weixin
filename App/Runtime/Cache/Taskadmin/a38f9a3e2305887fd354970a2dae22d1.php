...
.action_search .tabwidth
{
    ...
    <div class="showright"><span id="user_setting" class="fa fa-user">个人设置</span> <span id="user_out" class="fa fa-sign-out">退出登录</span></div>
                ...
                <div class="tabli">
                    <ul id="tabli">
                        ...
                        <li value="2" class='selected' style="width:200px;"><a href="/wisdom/index.php/Taskadmin/Salesreport/shareNum" style="text-decoration:none;">推广赚日金币总数</a></li>
            ...
            <div class="action_search">
                ...
                <span class="tabwidth" id="export"><a href="/wisdom/index.php/Taskadmin/Salesreport/exportPush" style="text-decoration:none;color:white;">导出</a></span>
            ...
            <div class="list">
                <ul>
                    <li style='width:35%;'>任务名称</li>
                    <li style='width:15%;'>任务金币</li>
                    <li style='width:20%;'>分享日期</li>
                    <li style='width:15%;'>分享次数</li>
                    <li style='width:15%;'>有效获得金币总数</li>
                </ul>
                <div class='listinfo'>
                        <ul>
    ...
    plist_shareNum($("#startTime").val(),$("#endTime").val(),$("#searcharea").val());
