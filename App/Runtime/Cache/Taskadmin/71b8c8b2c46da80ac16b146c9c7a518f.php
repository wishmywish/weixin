...
html, body {
    ...
    <body>
        <a href="<?php echo U('Taskadmin/Sales/example');?>">下载导入样例</a><br><br>

        <form name="frm1" enctype="multipart/form-data" action="<?php echo U('Taskadmin/Sales/import');?>" method="post">
           <input name="filename" type="file" value="上传文件" style="height:50px;"/><input name="submit" type="submit" value="导入" />
        </form>
