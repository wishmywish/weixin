...
.line_input1{
    ...
    <body>
            ...
            <div class="add">
                <input type="hidden" id="activityId" name="activityId" value="<?php echo ($reModi["list"]["f_id"]); ?>">

                <div class="line_input1">
                    <span>选择类型：</span>
                    <select name="type" id="type" style="width:285px">
                        <option value="1" <?php if(($reModi["list"]["f_type"]) == "1"): ?>selected<?php endif; ?>>广告</option>
                        <option value="3" <?php if(($reModi["list"]["f_type"]) == "3"): ?>selected<?php endif; ?>>活动</option>
                    </select>
                </div>

                <div class="line_input1">
                    <span>活动标题：</span> <input type="text" id="title" name="title" style="width:285px" value="<?php echo ($reModi["list"]["f_title"]); ?>"  placeholder="活动标题">
                </div>
                
                <div class="line_input1">
                   <span>活动时间：</span> 
                    <input id="startdate" class="laydate-icon" style="width: 285px;" placeholder="起始时间"  value="<?php echo ($reModi["list"]["f_starttime"]); ?>"/>  至
                    <input id="enddate" class="laydate-icon" style="width: 285px;" placeholder="终止时间"  value="<?php echo ($reModi["list"]["f_endtime"]); ?>"/>
                </div>

                <div class="line_input1">
                    <span>分享地址：</span> <input type="text" id="shareUrl" name="shareUrl" style="width:285px" value="<?php echo ($reModi["list"]["f_url"]); ?>" placeholder="分享地址">
                </div>

                <div class="line_input1">
                    <span>是否URL显示：</span> <input type="checkbox" id="isUrl" name="isUrl"  value="<?php echo ((isset($reModi["list"]["f_isurl"]) && ($reModi["list"]["f_isurl"] !== ""))?($reModi["list"]["f_isurl"]):0); ?>" <?php if(($reModi["list"]["f_isurl"]) == "1"): ?>checked<?php endif; ?>>
                </div>

                <div class="line_input1">
                    <span>分享描述：</span><br>
                    <textarea  value="" name="adDescription"  id="adDescription" style="width:550px;height:100px;"><?php echo ($reModi["list"]["f_desc"]); ?></textarea>
                </div>
                ...
                <div class="line_input1">
                    ...
                    <select name="isShow" id="isShow" style="width:85px">
                        <option value="1" <?php if(($reModi["list"]["f_top"]) == "1"): ?>selected<?php endif; ?>>是</option>
                        <option value="0" <?php if(($reModi["list"]["f_top"]) == "0"): ?>selected<?php endif; ?>>否</option>
                    </select>
                ...
                <div  class="line_input1">
                    <div class="upfile">
                        ...
                        <input type="hidden" id="fileid" name="fileid" value="<?php echo ($reModi["list"]["f_fid"]); ?>">
                    </div>
                </div>
                    ...
                    <div id="showPic" style="float: right;margin-right: 675px;margin-top: -75px;">
                        <img src="/wisdom/Public/upfile/<?php echo ($reModi["list"]["f_name"]["f_filepath"]); echo ($reModi["list"]["f_name"]["f_filename"]); ?>" width="100" height="100">
                    </div>
                    <?php }?>
...
<script>
       ...
       var um = UM.getEditor('editor',{
        ...
        // UM.addListener("ready", function () {
            // editor准备好之后才可以使用
            UM.getEditor('editor').setContent('<?php echo ($reModi["list"]["f_note"]); ?>');
        // });
