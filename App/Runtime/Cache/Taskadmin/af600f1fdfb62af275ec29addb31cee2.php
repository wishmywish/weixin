...
<body>
     ...
     <div class="add">
        <div class='info' style="background-color:white;">
            ...
            <div >
                <span>理由：</span><br>
                <textarea  value="" name="reason" cols="90" rows="10" id="reason" >同意！</textarea>
            </div>
            <input type="hidden" id="taskid" name="taskid" value="<?php echo ($taskid); ?>">
            <div style="  margin: 0 0 10px 200px;">
                <a class="btn btn-default" href="#" role="button" id="okReviewBtn">通过</a>&nbsp;&nbsp;&nbsp;
            </div>
            <div style="  margin: -44px 0 10px 282px;">
                <a class="btn btn-default" href="#" role="button" id="noReviewBtn">不通过</a>
            </div>
        </div>
    </div>
