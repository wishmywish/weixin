        ...
        <!--<li onclick="location.href = APP+'/Taskadmin/Report/index'"><span class="icon-globe"></span>&nbsp;&nbsp;&nbsp;&nbsp;统计报表</li>-->
            ...
            <div class="adminRight">
                ...
                <div class="tabli">
                    ...
                    <ul class="action">
                        <li id="salesAdd" value="0">导入业务员</li>
                        <li id="explodeAll" value="0"><a href="/wisdom/index.php/Taskadmin/Report/explodeAll" style="text-decoration:none;color:white;">导出</a></li>
                    </ul>
                </div>
