...
<script>
    ...
    $("#noteBtn").click(function(){
        ...
        //添加原因
        $.post("<?php echo U('Fun/adddealercause');?>","uninstall="+uninstall+"&ditch="+ditch+"&industry="+industry+"&job="+job+"&task="+task+"&area="+area+"&remark="+remark+"&id=<?php echo ($saleId); ?>",function(){
            layer.msg("添加原因成功");
            setTimeout(function(){
