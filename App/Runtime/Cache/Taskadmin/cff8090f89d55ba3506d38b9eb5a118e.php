...
.action_search .tabwidth
{
    ...
    <div class="showright"><span id="user_setting" class="fa fa-user">个人设置</span> <span id="user_out" class="fa fa-sign-out">退出登录</span></div>
                ...
                <div class="tabli">
                    <ul id="tabli">
                        ...
                        <li value="3" class='selected' style="width:200px;"><a href="/wisdom/index.php/Taskadmin/Salesreport/widelyShareNum" style="text-decoration:none;">随手赚日金币总数</a></li>
            ...
            <div class="action_search">
                ...
                <span class="tabwidth" id="export"><a href="/wisdom/index.php/Taskadmin/Salesreport/exportWide" style="text-decoration:none;color:white;">导出</a></span>
    ...
    plist_widelyShareNum($("#startTime").val(),$("#endTime").val(),$("#searcharea").val());
