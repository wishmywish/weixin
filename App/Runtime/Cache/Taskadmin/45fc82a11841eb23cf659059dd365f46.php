    ...
    <div class="cause">
        ...
        <div class="cause_note">
            <select id="industry">
                ...
                <option value="14">农业</option>
                <option value="15">旅游</option>
                <option value="16">医疗服务</option>
                <option value="17">银行</option>
                <option value="18">金融</option>
                <option value="19">机械制造</option>
                <option value="20">建筑</option>
                <option value="21">会计</option>
                <option value="22">服务</option>
                <option value="23">艺术</option>
                <option value="24">设计</option>
                <option value="25">保健</option>
                <option value="26">能源</option>
                <option value="27">电讯</option>
                <option value="28">司机</option>
                <option value="29">律师</option>
                <option value="30">出版</option>
                <option value="31">公益组织</option>
                <option value="32">互联网</option>
...
<script>
    ...
    $("#noteBtn").click(function(){
        ...
        //添加原因
        $.post("<?php echo U('Fun/addsalecause');?>","uninstall="+uninstall+"&ditch="+ditch+"&industry="+industry+"&job="+job+"&task="+task+"&area="+area+"&remark="+remark+"&id=<?php echo ($saleId); ?>",function(v){
            console.log(v);
            layer.msg("添加原因成功");
            setTimeout(function(){
