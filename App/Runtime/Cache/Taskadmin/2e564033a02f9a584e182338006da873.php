        ...
        <div class='info' style="background-color:white;    height: 160px;">
			...
			<div class="line">
	            <div class="line_input">
	                <span>任务原先开始时间：</span> 
	                <input id="startdate" class="laydate-icon" style="width: 120px;" value="<?php echo ($reModi["list"]["f_begindate"]); ?>" readonly>
	                <input id="time" type="hidden" value="<?php echo ($reModi["list"]["f_begindate"]); ?>" readonly>
	                <input id="endtime" type="hidden" value="<?php echo ($reModi["list"]["f_enddate"]); ?>" readonly>
	            </div>
            </div><br>
			...
			<div class="line">
	            <div class="line_input">
	                <span>任务新开始时间：</span> &nbsp;&nbsp;&nbsp;
	                <input id="newStartdate" class="laydate-icon" style="width: 120px;" value="<?php echo ($reModi["list"]["f_begindate"]); ?>">
	            </div>
            </div>
