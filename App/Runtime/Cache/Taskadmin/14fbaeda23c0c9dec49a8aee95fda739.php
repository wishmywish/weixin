    ...
    <div class="showright"><span id="user_setting" class="fa fa-user">个人设置</span> <span id="user_out" class="fa fa-sign-out">退出登录</span></div>
                ...
                <div class="tabli">
                    <ul id="tabli">
                        ...
                        <li value="4" class='selected' style="width:200px;"><a href="/wisdom/index.php/Taskadmin/Salesreport/allTaskShare" style="text-decoration:none;">全部任务日分享数</a></li>
            ...
            <div class="action_search">
                ...
                <span class="tabwidth" id="export"><a href="/wisdom/index.php/Taskadmin/Salesreport/exportTaskShare" style="text-decoration:none;color:white;">导出</a></span>
