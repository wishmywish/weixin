        ...
        <div class="add">
            <div class="add_business">
                <div class="page_next" id="push_one">
                   ...
                   <input type="hidden" id="userid" value="<?php echo ($reModi["list"]["id"]); ?>">

                   <div class="line">
                        <div class="line_input">
                           <span>用户名:</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="username" placeholder="用户名" value="<?php echo ($reModi["list"]["username"]); ?>">
                        </div>
                    ...
                    <div class="line">
                        <div class="line_input">
                           <span>真实姓名：</span> <input type="text" id="realname" placeholder="真实姓名" value="<?php echo ($reModi["list"]["realname"]); ?>">
                        </div>
