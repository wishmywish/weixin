    ...
    <body>
        <div class="login">
            <div class="login_top">
                ...
                <!--<div class="login_top_url">APP下载&nbsp;&nbsp;&nbsp;&nbsp;使用说明&nbsp;&nbsp;&nbsp;&nbsp;-->
                    <!--| &nbsp;&nbsp;&nbsp;&nbsp;-->
                    <!--<a><i class="fa fa-qq"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a><i class="fa fa-weixin"></i></a>-->
                <!--</div>-->
            </div>
                    ...
                    <div class="form">
                        ...
                        <div class="form_input">
                            ...
                            <div id="code_div">
                                ...
                                <div>
                                    <img src="<?php echo U('Login/verify');?>" alt="" class="code_show" title="点击刷新">
                                </div>
                            </div>
                            <!--验证码 end-->
...
<div style="display: none;"><script src="http://s11.cnzz.com/z_stat.php?id=1256375228&web_id=1256375228" language="JavaScript"></script></div>
    ...
    <script>
        //点击改变验证码
        var verifyimg = $(".code_show").attr("src");
        ...
        function psw_next(){
           ...
           $.get(APP+"/Api/Info/conf","command=codeauth&code="+give_code+"&voicephone="+give_mobile,function(val){
                  if(val.error_code=="success"){
                  	   layer.msg("手机验证成功");
                       $.post("<?php echo U('Home/Api/searchCnameBymobile');?>","mobile="+give_mobile,function(re){
                            //layer.close(loadi);
//                            console.log(re+"======");
                        if(re!=""){
        ...
        function  mod_complete(){
        	...
        	$.post("<?php echo U('Home/Api/WebChangePwd');?>","mobile="+give_mobile+"&password="+give_password+"&companyId="+give_companyId,function(rel){
//        		 console.log(rel+"=====");
        		 if(rel=="000000"){
        		 	layer.msg("密码修改成功");
                    $("#compsw").css('display','none');
        ...
        Cookie.eraseCookie('smallMenuIndex','0');
            ...
            $('#back_to_login').click(function(){
                ...
                $.get(APP+"/Api/Info/conf","command=codeauth&code="+register_code+"&voicephone="+register_mobile,function(val){
                    if(val.error_code=="success"){
                        if(register_companyId==""){
                            webregcompany(register_companyName,register_mobile,register_password); //厂家中第一个用户注册
                        }else{
                            $.post(APP+"/Api/Web/getCompanyDetail2","companyId="+register_companyId,function(v){
                                //console.log(v+"小包册数"+register_companyName);
                                //console.log(v.list.companyName+"======="+register_companyName);
                                    if(v.list.companyName==register_companyName){
             ...
             //厂家中第一个用户注册
            function   webregcompany(register_companyName,register_mobile,register_password){
...
//                    layer.close(loadi);
            ...
            function  login(){
                ...
                var  login_code = $("input[name=code]").val();  //输入的验证码
...
//                $.post("check_verify",{"code":login_code},function(data){
//                    if( data == 0 ){
//                        layer.msg("验证码输入错误",{icon:8});
//                        $("input[name=code]").focus();
//                        return false;
//                    }
//
...
//                             console.log(companyList);
                                    ...
                                    content+="</ul>";
                                    content+="<div style='text-align:center;margin-top:50px;color:#fff;background-color:#14bce1;width:80px;height:30px;padding-top:10px;cursor:pointer;border-radius:5px;margin-bottom: 20px;'  onclick='login_company_confirm("+login_mobile+")'>确定</div>"
                                    layer.open({
                                        type:1,
                                        title:'请选择公司名称',
