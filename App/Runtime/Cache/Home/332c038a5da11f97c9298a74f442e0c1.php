        ...
        <div class="head">
            <div class="head_center">
                ...
                <div class="personal_info">
                    <div  style="width:100%;"><div class="pro_img"></div><div><?php echo empty(cookie("nickName"))?cookie("mobile"):cookie("nickName"); ?><b class="caret"></b></div></div>
...
<!--                <div class="task_button_right">
            ...
            <div  class='promotion_task_list1'>
                ...
                <div id="proallpage" class="pagebar" style="color:#696969;margin-top:30px"></div>
            </div>
        </div>
        ...
        <!--推广赚-->
         ...
         <div id="a1" style="display:none">
            ...
            <div  class='promotion_task_list1'>
                ...
                <div id="proallpage2"  class="pagebar" style="color:#696969;margin-top:30px"></div>
        ...
        <!--随手赚-->
         ...
         <div id="a2" style="display:none">
            ...
            <div  class='promotion_task_list1'>
                ...
                <div id="proallpage3" class="pagebar" style="color:#696969;margin-top:30px">
...
<script>           
  ...
  //empty_list
   var empty_list="<ul><li><div style=\'margin:20px;height:160px;line-height:26px;text-align:center;\'><div  style='padding-top:50px;color:#f47469'>暂无数据，请创建任务!!</div></div></li></ul>"
   var loadi="";
...
//          	console.log(v);
                ...
                reson="<span style='margin-left:50px;color:#f47469;cursor:pointer;'><u onclick='showreject("+f_taskid+")'>反馈信息查看</u></span>";
                  //创建任务时间
                 var createDate1=createDate(v.f_creatdate);
                 var tasktypeid=v.f_tasktypeid;
              //   console.log(tasktypeid+'====================');N
                  list+='<ul id=\'pro_task_list_'+(i+1)+'\'><li><div style=\'margin:20px;height:100px;line-height:26px\'> 任务编号&nbsp :'+v.f_surveno+' <span  style=\'float:right\'>发布时间&nbsp :'+createDate1+'</span></br>'
                       +'任务标题&nbsp : '+v.f_title+'</br>'
                       +'任务总数&nbsp ：'+v.f_totalcopies+'<span  style=\'margin-left:150px;\'>单次奖励金币&nbsp ：'+v.f_eachcoin+'(1元=10金币)</span></br>'
                       +'平台单次服务佣金&nbsp :'+v.f_eachcoin_plat+' <span  style=\'margin-left:104px;color:#12A1C9\'>总佣金&nbsp :'+v.f_plattotal+'\元</span></br>' 
                       +'任务截止时间&nbsp ：'+v.f_enddate+'<span  style=\'margin-left:109px;color:#F08304\'>任务状态&nbsp :'+current_status+'</span>'
                       +reson+"<span  style=\'margin-left:50px;color:#00a73d;;cursor:pointer;\'><u onclick='preview("+f_taskid+")'>任务预览</u></span>";
                 if (v.f_status==1 ||v.f_status==5||v.f_status==6) {     
                     if(id===0){
                         list+='<?php if( !in_array("d3",$access_array) ){ echo "<!--"; } ?><span style=\'float:right;\'><a style=\'color:#00a73d;margin-right:30px\' href=\'#\' onclick=\'pro_task_modi('+v.f_tid+','+(i+1)+','+tasktypeid+')\'>编辑</a><?php if( !in_array("d3",$access_array) ){ echo "-->"; } if( !in_array("d2",$access_array) ){ echo "<!--"; } ?><a style=\'color:red\' href=\'#\' onclick=\'business_task_del('+v.f_tid+','+(i+1)+',"pro_task_list_" ,"promotionAllTask","proallpage",0)\'>删除</a><?php if( !in_array("d2",$access_array) ){ echo "-->"; } ?></span>'
                           +'</div></li></ul>'; 
                     }else if(id===1){
                          list+='<?php if( !in_array("d3",$access_array) ){ echo "<!--"; } ?><span style=\'float:right;\'><a style=\'color:#00a73d;margin-right:30px\' href=\'#\' onclick=\'pro_task_modi('+v.f_tid+','+(i+1)+','+tasktypeid+')\'>编辑</a><?php if( !in_array("d3",$access_array) ){ echo "-->"; } if( !in_array("d2",$access_array) ){ echo "<!--"; } ?><a style=\'color:red\' href=\'#\' onclick=\'business_task_del('+v.f_tid+','+(i+1)+',"pro_task_list_" ,"promotionAllTask2","proallpage2",1)\'>删除</a><?php if( !in_array("d2",$access_array) ){ echo "-->"; } ?></span>'
                           +'</div></li></ul>'; 
                     }else{
                          list+='<?php if( !in_array("d3",$access_array) ){ echo "<!--"; } ?><span style=\'float:right;\'><a style=\'color:#00a73d;margin-right:30px\' href=\'#\' onclick=\'pro_task_modi('+v.f_tid+','+(i+1)+','+tasktypeid+')\'>编辑</a><?php if( !in_array("d3",$access_array) ){ echo "-->"; } if( !in_array("d2",$access_array) ){ echo "<!--"; } ?><a style=\'color:red\' href=\'#\' onclick=\'business_task_del('+v.f_tid+','+(i+1)+',"pro_task_list_" ,"promotionAllTask3","proallpage3",2)\'>删除</a><?php if( !in_array("d2",$access_array) ){ echo "-->"; } ?></span>'
                           +'</div></li></ul>'; 
                     } 
                 }else{
                          list+='</div></li></ul>'; 
