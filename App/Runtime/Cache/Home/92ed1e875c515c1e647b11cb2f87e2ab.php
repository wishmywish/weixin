                ...
                <div  class="table1_center_body" style="margin-top:40px;">
                    <div class="table1_center_body_left">
                        <div  class="body_title">推广赚</div>
                            <div  id="pro_taskAchieve_make" style="height:350px;width:450px;"><img src='/wisdom/Public/Home/Default/images/nonedata2.png'/></div>
                    </div>
                    <div class="table1_center_body_right" style="margin-right:20px">
                        <div class="body_title">随手赚</div>
                                 <div  id="pro_taskAchieve_earn" style="height:350px;width:450px;"><img src='/wisdom/Public/Home/Default/images/nonedata2.png'/></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="index_right_table">
            ...
            <div  class="table1_center">
                <div  class="table1_center_body" style="margin-top:40px;">
                    <div class="table1_center_body_left" >
                        <div  class="body_title">推广赚</div>
                            <div  id="pro_taskExpend_make" style="height:300px;"><img src='/wisdom/Public/Home/Default/images/nonedata2.png'/></div>
                    </div>
                    <div class="table1_center_body_right" style="margin-right:20px">
                        <div class="body_title">随手赚</div>
                                 <div  id="pro_taskExpend_earn" style="height:300px;"><img src='/wisdom/Public/Home/Default/images/nonedata2.png'/></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div  class="table3_center">
                <div class="table3_center_body">
                    ...
                    <div class="table1_center_body_left" style="width:420px;">
                        <div  class="body_title">推广赚</div>
                            <div  id="pro_taskReport_make" style="height:450px;"><img src='/wisdom/Public/Home/Default/images/nonedata2.png'/></div>
                    </div>
                    <div class="table1_center_body_right" style="width:420px;margin-right:20px;" >
                        <div class="body_title">随手赚</div>
                                 <div  id="pro_taskReport_earn" style="height:450px"><img src='/wisdom/Public/Home/Default/images/nonedata2.png'/></div>
                    </div>             
        </div>
            </div>
        </div>
